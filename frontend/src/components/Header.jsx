...
export default function Header({ onResetView, isResultsPage, searchParams, onEditSearch, onOpenFilters }) {
        ...
        <header ref={headerRef} className="hidden md:block w-full bg-black text-white select-none z-50 sticky top-0 border-b border-neutral-800/80 shadow-md">
          <div className="w-full max-w-[1100px] mx-auto px-4 py-3 h-[64px]">
            <div className="flex items-center justify-between h-full">
              ...
              {/* Right options */}
              <div className="flex items-center gap-6 text-[16px] font-medium text-white tracking-tight">
                <button 
  ...
  return (
    ...
    >
      ...
      {/* Navigation Items */}
      <div className="flex flex-col items-end justify-center h-full pr-12 md:pr-16 lg:pr-24 space-y-7">
        {[
          'OUR FLEET',
          'LOCATIONS',
          'W ONE SUBSCRIPTION',
          ...
          <div key={idx} className="sidebar-nav-item group cursor-pointer flex items-center" onClick={() => setIsSidebarOpen(false)}>
